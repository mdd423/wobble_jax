...
def main():
    ...
    model_name = '../out/model{}n{}_l{}_r{}f.pt'.format(file_tail,args.n,args.l,args.r)
    ...
    model  = wobble_model.JnpLinErr(args.n,y[args.l:args.r],x[args.l:args.r],y_err[args.l:args.r],x_shifts)
    model.optimize(loss,maxiter=args.maxiter)

    # model.plot(xlim=(9.455,9.456))
    # plt.savefig(outdir + )

    wobble_model.save_model('../models/model{}n{}_l{}_r{}_mI{}f.pt'.format(file_tail,args.n,args.l,args.r,args.maxiter),model)
    ...
    model_2 = wobble_model.JnpVelLinErr(args.c,y[args.l:args.r],x[args.l:args.r],y_err[args.l:args.r],x_min,pretrained=model)
