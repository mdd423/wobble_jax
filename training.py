...
def main():
    ...
    res, callback = model.optimize(loss_1,x[:,args.l:args.r],y[:,args.l:args.r],yerr[:,args.l:args.r],args.maxiter)
    ...
    loss_array    = wobble_data.get_loss_array(shift_grid,model,x[:,args.l:args.r],y[:,args.l:args.r],yerr[:,args.l:args.r],loss_1)
    ...
    results = model_2.optimize(loss_1,x[:,args.l:args.r],y[:,args.l:args.r],yerr[:,args.l:args.r],args.maxiter2)
